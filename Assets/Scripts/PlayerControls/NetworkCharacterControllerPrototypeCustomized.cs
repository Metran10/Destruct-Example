...
public class NetworkCharacterControllerPrototypeCustomized : NetworkTransform {
  ...
  public float verticalViewSpeed = 50.0f;
  ...
  public virtual void Move(Vector3 direction) {
    ...
    {
        transform.Rotate(0, rotation * Runner.DeltaTime * rotationSpeed, 0);
    }
